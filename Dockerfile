...
RUN python3 -m pip install wridgets
...
RUN python3 -m pip install microns-utils
...
RUN export TAG=$(curl -s 'https://api.github.com/repos/cajal/microns-nda/releases?per_page=1' | grep -oP '"name": "\K(.*)(?=")'); \ 
    python3 -m pip install git+https://github.com/cajal/microns-nda.git@$TAG#subdirectory=python/microns-nda-api
...
RUN export TAG=$(curl -s 'https://api.github.com/repos/cajal/microns-materialization/releases?per_page=1' | grep -oP '"name": "\K(.*)(?=")'); \ 
    python3 -m pip install git+https://github.com/cajal/microns-materialization.git@$TAG#subdirectory=python/microns-materialization-api
...
RUN export TAG=$(curl -s 'https://api.github.com/repos/cajal/microns-morphology/releases?per_page=1' | grep -oP '"name": "\K(.*)(?=")'); \ 
    python3 -m pip install git+https://github.com/cajal/microns-morphology.git@$TAG#subdirectory=python/microns-morphology-api
...
RUN export TAG=$(curl -s 'https://api.github.com/repos/cajal/microns-coregistration/releases?per_page=1' | grep -oP '"name": "\K(.*)(?=")'); \ 
    python3 -m pip install git+https://github.com/cajal/microns-coregistration.git@$TAG#subdirectory=python/microns-coregistration-api
...
RUN export TAG=$(curl -s 'https://api.github.com/repos/cajal/microns-manual-proofreading/tags?per_page=1' | grep -oP '"name": "\K(.*)(?=")'); \ 
    python3 -m pip install git+https://github.com/cajal/microns-manual-proofreading.git@$TAG#subdirectory=python/microns-manual-proofreading-api
...
RUN export TAG=$(curl -s 'https://api.github.com/repos/cajal/microns-dashboard/tags?per_page=1' | grep -oP '"name": "\K(.*)(?=")'); \ 
    python3 -m pip install git+https://github.com/cajal/microns-dashboard.git@$TAG